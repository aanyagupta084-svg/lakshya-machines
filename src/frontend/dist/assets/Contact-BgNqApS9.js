...
import { f as ProtocolError, T as TimeoutWaitingForResponseErrorCode, u as utf8ToBytes, E as ExternalError, h as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, i as RequestStatusDoneNoReplyErrorCode, k as RejectError, m as CertifiedRejectErrorCode, n as UNREACHABLE_ERROR, I as InputError, o as InvalidReadStateRequestErrorCode, p as ReadRequestType, q as Principal, s as IDL, t as MissingCanisterIdErrorCode, H as HttpAgent, v as encode, Q as QueryResponseStatus, w as UncertifiedRejectErrorCode, x as isV3ResponseBody, y as isV2ResponseBody, z as UncertifiedRejectUpdateErrorCode, A as UnexpectedErrorCode, F as decode, G as Subscribable, J as pendingThenable, K as resolveEnabled, N as shallowEqualObjects, O as resolveStaleTime, V as noop$1, Y as environmentManager, Z as isValidTimeout, _ as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, a3 as notifyManager, r as reactExports, a4 as shouldThrowError, a5 as useQueryClient, a6 as useInternetIdentity, a7 as createActorWithConfig, c as createLucideIcon, a8 as Record, a9 as Service, aa as Func, ab as Vec, ac as Text, ad as Int, ae as Nat, j as jsxRuntimeExports, d as cn, af as createSlot$1, ag as composeRefs, ah as React2, ai as useComposedRefs, aj as reactDomExports, ak as React, al as ReactDOM, D as DEFAULT_WHATSAPP_MESSAGE, a as MessageCircle, W as WHATSAPP_DISPLAY, g as getWhatsAppLink, B as Button, am as openWhatsApp, P as Phone, M as MapPin, b as MACHINES } from "./index-BY5p7aNM.js";
import { a as ChevronDown, C as ChevronUp, I as Input } from "./input-B8dLcJiB.js";
...
Service({
  ...
  "submitInquiry": Func([InquiryInput], [Inquiry], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Inquiry2 = IDL2.Record({
    ...
    "name": IDL2.Text,
    "email": IDL2.Text,
    "machineInterest": IDL2.Text,
    "message": IDL2.Text,
    "timestamp": IDL2.Int,
    "phone": IDL2.Text
  });
  const InquiryInput2 = IDL2.Record({
    "name": IDL2.Text,
    "email": IDL2.Text,
    "machineInterest": IDL2.Text,
    "message": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "submitInquiry": IDL2.Func([InquiryInput2], [Inquiry2], [])
  });
};
class Backend {
...
function Contact() {
  ...
  const selectedMachineLabel = ((_a2 = MACHINE_OPTIONS.find((m) => m.value === form.machineInterest)) == null ? void 0 : _a2.label) ?? "";
  const whatsappMessage = form.machineInterest ? `Hi Lakshya Keshari, I'm interested in ${selectedMachineLabel}. ${form.message || DEFAULT_WHATSAPP_MESSAGE}` : DEFAULT_WHATSAPP_MESSAGE;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b rust-stripe py-12 md:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "max-w-2xl",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary font-display font-semibold text-sm uppercase tracking-widest mb-2", children: "Get In Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl md:text-4xl text-foreground mb-3 text-balance", children: "Talk to Lakshya Keshari Directly" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-base md:text-lg", children: "Have a question about our food processing machinery? Reach out via WhatsApp for the fastest response, or fill in the inquiry form below." })
        ]
      }
    ) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-accent/10 border-b border-accent/20 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-accent flex items-center justify-center shadow-elevated shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-7 h-7 text-accent-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm", children: "WhatsApp — Fastest Response" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 md:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-10 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-6 md:p-8 shadow-elevated border border-border bg-card", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl md:text-2xl text-foreground mb-1", children: "Send an Inquiry" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm mb-6", children: "Fill in your details and we'll get back to you — or click the WhatsApp button to connect instantly." }),
            formState === "success" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: "Inquiry received!" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm font-body", children: [
                      "Lakshya Keshari will reach out to you soon. For faster response,",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "a",
                        {
            ...
            formState === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: "Submission failed" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm font-body", children: [
                      "Please try again or",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Select,
                  {
                    ...
                    onValueChange: (val) => handleChange("machineInterest", val),
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        SelectTrigger,
                        {
                          ...
                          "aria-describedby": errors.machineInterest ? "machine-error" : void 0,
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select a machine or inquiry type" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: MACHINE_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: opt.value, children: opt.label }, opt.value)) })
                    ]
                  }
                ),
                errors.machineInterest && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    id: "machine-error",
                    className: "text-destructive text-xs font-body",
                    "data-ocid": "contact.machine.field_error",
                    children: errors.machineInterest
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 pt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: formState === "submitting" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
          ...
          children: [
              ...
              Card,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-base leading-tight", children: "Lakshya Keshari" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-xs", children: "Owner & Food Processing Specialist" })
                    ] })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-4 h-4 text-accent mt-0.5 shrink-0" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-xs mb-0.5", children: "WhatsApp" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "a",
                          {
                            href: getWhatsAppLink(),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-xs mb-0.5", children: "Phone" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "a",
                          {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-xs mb-0.5", children: "Address" }),
              ...
              Card,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-sm", children: "Business Hours" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                    BUSINESS_HOURS.map((slot) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        className: "flex justify-between items-center py-1.5 border-b border-border last:border-0",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-foreground", children: slot.day }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm font-semibold text-primary", children: slot.hours })
                        ]
                      },
                      slot.day
                    )),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-xs pt-1", children: "WhatsApp responses available outside hours — we reply as soon as possible." })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                onClick: () => openWhatsApp(DEFAULT_WHATSAPP_MESSAGE),
                onKeyDown: (e) => e.key === "Enter" && openWhatsApp(DEFAULT_WHATSAPP_MESSAGE),
                "data-ocid": "contact.whatsapp_cta_card",
                "aria-label": "Chat on WhatsApp for quick inquiries",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-accent-foreground/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-5 h-5 text-accent-foreground" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-accent-foreground text-sm leading-tight", children: "Quick inquiry? WhatsApp us" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent-foreground/80 font-body text-xs mt-0.5", children: "Get pricing & availability in minutes" })
                  ] })
                ]
              }
            )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/40 border-t border-border py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground mb-1", children: "Visit Our Showroom" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm", children: "See our food processing machines in person at our Varanasi showroom." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl overflow-hidden border border-border shadow-subtle bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "iframe",
        {
